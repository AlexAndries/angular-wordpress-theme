...
//    if($side == "multiple"){
	if($hex != "transparent"){
		$color = ultra_hextorgba($hex, $opacity);
	}else{
		$color = "transparent";
...
function ultra_css_bgcolor($selector, $id, $opacity = "", $valuetype = ""){
	...
	if($value == "transparent"){
		...
		$color = ultra_hextorgba($value, $opacity);
	}
	...
	if(isset($color) && trim($color) != "" && trim($color) != "#"){
		if($color == "transparent"){
			...
			if(trim($colorexp[0]) == "primary"){
				$code = $ultraadmin['primary-color'];
			}else if(trim($colorexp[0]) == "primary2"){
				$code = $ultraadmin['primary2-color'];
			}else if(trim($colorexp[0]) == "secondary"){
				$code = $ultraadmin['secondary-color'];
			}else{
