...
function ultra_scripts(){
	global $ultraadmin;
	$url = THEME_URL . 'includes/ultra-admin/js/ultra-scripts.js';
	wp_deregister_script('ultra-scripts-js');
	wp_register_script('ultra-scripts-js', $url);
	wp_enqueue_script('ultra-scripts-js');
	$url = THEME_URL . 'includes/ultra-admin/js/ultra-smoothscroll.min.js';
	...
	if(isset($plug) && $plug == "ultra-admin-addon_page_ultra_menumng_settings"){
		$url = THEME_URL . 'includes/ultra-admin/css/jquery-ui/minified/jquery-ui.min.css';
		wp_deregister_style('ultra-jqueryui');
		wp_register_style('ultra-jqueryui', $url);
		wp_enqueue_style('ultra-jqueryui');
		$url = THEME_URL . 'includes/ultra-admin/js/ultra-jquery.ui.elements.js';
...
function ultra_admin_css(){
	global $ultra_css_ver;
	$url = THEME_URL . 'includes/ultra-admin/' . $ultra_css_ver . '/ultra-admin.css';
	wp_deregister_style('ultra-admin');
	wp_register_style('ultra-admin', $url);
	wp_enqueue_style('ultra-admin');
	/*ame*/
	$url = THEME_URL . 'includes/ultra-admin/css/ultra-ame.css';
	wp_deregister_style('ultra-ame');
	wp_register_style('ultra-ame', $url);
	wp_enqueue_style('ultra-ame');
	/*wordfence*/
	$url = THEME_URL . 'includes/ultra-admin/css/ultra-wordfence.css';
	wp_deregister_style('ultra-wordfence');
	wp_register_style('ultra-wordfence', $url);
	wp_enqueue_style('ultra-wordfence');
	/*other plugins compatibility*/
	$url = THEME_URL . 'includes/ultra-admin/css/ultra-external.css';
	wp_deregister_style('ultra-external');
...
function ultra_default_css_colors(){
	...
	$css_path = THEME_URL . 'includes/ultra-admin/' . $ultra_css_ver . '/colors';
	$css_dir = THEME_URL . 'includes/ultra-admin/' . $ultra_css_ver . '/colors';
...
function ultra_dynamic_enqueue_style(){
	global $ultra_css_ver;
	if(!is_multisite()){
		$url = THEME_URL . 'includes/ultra-admin/' . $ultra_css_ver . '/ultra-colors.css';
	}else if(is_multisite() && ultra_network_active()){
		// IF NETWORK ACTIVE
		global $wpdb;
		$current_site = 1;
		$url = THEME_URL . 'includes/ultra-admin/' . $ultra_css_ver . '/ultra-colors-site-' . $current_site . '.css';
	}else{
...
function ultra_regenerate_dynamic_css_file($newultraadmin = array(), $filename = "", $basedir = ""){
	...
	if(trim($filename) != ""){
		$newfilename = "ultra-colors-" . $filename;
	}
